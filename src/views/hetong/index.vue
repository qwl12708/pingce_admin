      ...
      <el-table-column fixed="right" label="操作" width="180">
        <template #default="scope">
          <div class="flex gap-2">
            ...
            <el-button v-if="scope.row.status === '待审批'" link type="primary" size="small">审批合同</el-button>
...
import { ref } from 'vue'
import { ElButton, ElTable, ElTableColumn, ElTag, ElPagination, ElInput } from 'element-plus'
